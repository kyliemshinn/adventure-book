...
export declare type TabsProps<T> = React.HTMLAttributes<HTMLDivElement> & IComponentBaseProps & {
...
declare const _default: (<T>(props: React.HTMLAttributes<HTMLDivElement> & IComponentBaseProps & {
